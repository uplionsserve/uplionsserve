...
<svelte:window on:load={initializeAtTop} on:scroll={debounce(handleScroll, 100, {leading: true})} />
<header class="
    w-full
    fixed z-20
    ...
    <div class="
            ...
            <div class="flex items-center gap-2 h-16">
                <a href="https://lionsclubs.org/en">
                    <img
                        ...
                        class="w-16 {atTop ? 'brightness-0 invert' : 'brightness-100 invert-0'}"/>
                </a>
                <a href="/">
                    <img
                        src="/graphics/brands/logo-upls-short-uplscolor.svg"
                        alt="U.P. Lions Serve abbreviated logo"
                        class="w-28 {atTop ? 'brightness-0 invert' : 'brightness-100 invert-0'}"/>
                </a>
            </div>
            <button
                on:click={handleMenu}
        ...
        <div class="md:pt-2 hidden md:flex items-start gap-4">
                <a href="https://facebook.com/uplionsserve" class="w-8 fill-upls-orange pt-[0.8rem] {atTop ? 'brightness-0 invert' : 'brightness-100 invert-0'}">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M504 256C504 119 393 8 256 8S8 119 8 256c0 123.78 90.69 226.38 209.25 245V327.69h-63V256h63v-54.64c0-62.15 37-96.48 93.67-96.48 27.14 0 55.52 4.84 55.52 4.84v61h-31.28c-30.8 0-40.41 19.12-40.41 38.73V256h68.78l-11 71.69h-57.78V501C413.31 482.38 504 379.78 504 256z"/></svg>
                </a>
                <a href="https://instagram.com/uplionsserve" class="w-8 fill-upls-orange pt-3 {atTop ? 'brightness-0 invert' : 'brightness-100 invert-0'}">
